# source( "~/labo/src/lightgbm/z633_lightgbm_BO_final.r" )
# Este script se corrió en Google Cloud
#   8 vCPU
# 256 GB memoria RAM (Podría haber sido menos)
...
kdataset       <- "./exp/FE6110/dataset_7130_FEfinal_Caro.csv.gz"         # El dataset generado con Feature Engineering
ksemilla_azar  <- 788065  #Aqui poner la propia semilla
kexperimento   <- "HT6330final"
ktraining      <- c( 202003, 202004, 202005, 202007, 202008, 202009, 202010, 202011, 202012, 202101 )   #periodos en donde entreno
